...
/**
 * Schema to validate incoming crawl requests
 *
 * NOTE: crawler does not has the option to include raw HTML and it only include clean HTML
 *
 ...
 * @property allowExternalLinks - allow crawling onto external links (apart from base domain)
...
export type CrawlRequestSchema = z.infer<typeof crawlRequestSchema>;
